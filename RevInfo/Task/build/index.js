...
document.addEventListener("DOMContentLoaded", function () { return __awaiter(void 0, void 0, void 0, function () {
    var scopedWindow, _a, account, providerEngine, client, provider, chainId, daiToken, usdcToken, daiDecimals, usdcDecimals, zeroExDeployedAddresses;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                usdcDecimals = _b.sent();
                misc_1.linkBtnToCallback("mintDAI", function () { return misc_1.mintTokens(account, misc_1.FAKE_DAI, provider, misc_1.DEFAULT_MINT_AMOUNT); });
                misc_1.linkBtnToCallback("mintUSDC", function () { return misc_1.mintTokens(account, misc_1.FAKE_USDC, provider, misc_1.DEFAULT_MINT_AMOUNT); });
                misc_1.linkBtnToCallback("swapDaiForUsdc", function () { return exercise_1.performSwapAsync(usdcToken, daiToken, 100, account, provider); });
                misc_1.linkBtnToCallback("swapUsdcForDai", function () { return exercise_1.performSwapAsync(daiToken, usdcToken, 100, account, provider); });
                zeroExDeployedAddresses = contract_addresses_1.getContractAddressesForChainOrThrow(contract_addresses_1.ChainId.Kovan);
                setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                usdcBalance = _a.sent();
                                return [4 /*yield*/, daiToken.allowance(account, zeroExDeployedAddresses.erc20Proxy).callAsync()];
                            case 3:
                                daiAllowance = _a.sent();
                                return [4 /*yield*/, usdcToken.allowance(account, zeroExDeployedAddresses.erc20Proxy).callAsync()];
                            case 4:
                                ...
                                ;
                                misc_1.setTextOnDOMElement('fakeDaiBalance', web3_wrapper_1.Web3Wrapper.toUnitAmount(daiBalance, daiDecimals.toNumber()).decimalPlaces(2).toString());
                                misc_1.setTextOnDOMElement('fakeUsdcBalance', web3_wrapper_1.Web3Wrapper.toUnitAmount(usdcBalance, usdcDecimals.toNumber()).decimalPlaces(2).toString());
                                misc_1.setTextOnDOMElement('fakeDaiAllowance', daiAllowanceText.toString());
                                misc_1.setTextOnDOMElement('fakeUsdcAllowance', usdcAllowanceText.toString());
                                return [2 /*return*/];
                        }
                    });
                }); }, 2000);
